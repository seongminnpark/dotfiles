...
window.JST["onboarding/device/plug"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<div id="content-container">\n    <div class="logo-container">\n        <img src="../../assets/images/onboarding/large_logo.png" width="191" height="96">\n    </div>\n    <div class="greyed-container">\n        <img src="../assets/images/common/plug_wallet.png" height="50" width="50"/>\n        <div class="black-indication">');
    
      __out.push(__sanitize(t('onboarding.device.plug.welcome_instruction')));
    
      __out.push('</div>\n        <span class="medium-indication">');
    
      __out.push(__sanitize(t('onboarding.device.plug.welcome_bolos_instruction')));
