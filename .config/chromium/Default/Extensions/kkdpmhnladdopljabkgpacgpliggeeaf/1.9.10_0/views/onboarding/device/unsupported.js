...
window.JST["onboarding/device/unsupported"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(t('onboarding.device.unsupported.not_linked')));
    
      __out.push('</div>\n    <div class="medium-indication">');
    
      __out.push(__sanitize(t('onboarding.device.unsupported.please_update')));
