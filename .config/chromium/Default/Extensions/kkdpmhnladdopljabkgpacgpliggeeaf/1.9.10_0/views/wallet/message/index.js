...
window.JST["wallet/message/index"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(t('wallet.message.index.path')));
    
      __out.push('" id="derivation_path" />\n          <select id="address"></select>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n  <textarea class="rounded-text-area" id="message" placeholder="');
      ...
      __out.push(__sanitize(t('wallet.message.index.sign')));
