...
window.JST["wallet/settings/hardware"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<section id="settings_hardware_dialog">\n  <header>\n    <h1>');
    
      __out.push(__sanitize(t('wallet.settings.common.hardware')));
    
      __out.push('</h1>\n  </header>\n  <div id="firmware_table_container"></div>\n  <div id="smartphones_table_container"></div>\n</section>\n<div class="dialog-actions-bar">\n  <a class="uppercase-action" href="#openOtherSettings">');
