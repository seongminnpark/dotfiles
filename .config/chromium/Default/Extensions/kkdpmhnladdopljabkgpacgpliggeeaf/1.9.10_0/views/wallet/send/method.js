...
window.JST["wallet/send/method"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<section id="send_method_dialog">\n  <header>\n    <h1>');
    
      __out.push(__sanitize(_.str.sprintf(t('wallet.send.common.send_bitcoins'), ledger.config.network.plural)));
    
      __out.push('</h1>\n  </header>\n  <div class="regular-text">');
    
      __out.push(t('wallet.send.method.select_method'));
    
      __out.push('</div>\n  <div id="mobile_table_container"></div>\n  <div id="card_table" class="large-table">\n    <a class="header fixed" href="#selectSecurityCard">\n      <div class="uppercase-section-column stretchable">');
    
      __out.push(__sanitize(t('wallet.send.method.security_card')));
