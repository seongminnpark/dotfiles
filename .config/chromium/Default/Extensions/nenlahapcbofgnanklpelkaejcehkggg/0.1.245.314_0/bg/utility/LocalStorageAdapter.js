...
Store.prototype.get = function(keys) {
  return new Promise(function(resolve, reject) {
    chrome.storage.local.get(this.transformToNamespaceKeys(keys), resolver.bind(this, resolve, reject));
  }.bind(this));
};

Store.prototype.set = function(keys) {
  return new Promise(function(resolve, reject) {
    chrome.storage.local.set(this.transformToNamespaceKeys(keys), resolver.bind(this, resolve, reject));
  }.bind(this));
};

Store.prototype.remove = function(keys) {
  return new Promise(function(resolve, reject) {
    chrome.storage.local.remove(this.transformToNamespaceKeys(keys), resolver.bind(this, resolve, reject));
  }.bind(this));
};
