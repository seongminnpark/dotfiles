import {runV2} from 'iv-wb-light/dist/iv-wb-light-chrome';
...
export default async ({asin, userId, prime, zipcode, address, product, price, seller, meta = {}}) => {
  prime = prime || (typeof settingsCursor.get('prime') === 'boolean' ? settingsCursor.get('prime') : true);
  ...
  return new Promise((resolve) => {
    runV2({asin, userId, prime, zipcode, address, product, features, events, price, seller, meta}, ({runId, type}) => {
