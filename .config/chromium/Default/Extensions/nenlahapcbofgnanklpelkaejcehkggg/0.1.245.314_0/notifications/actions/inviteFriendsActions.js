...
export async function sendInvites(data) {
  ...
  data.feature = hasFeature('referral_inc_control') ? 'referral_inc_control' : hasFeature('referral_inc_gg5') ? 'referral_inc_gg5' : hasFeature('referral_inc_g5') ? 'referral_inc_g5' : '';
