...
class OfferWhenUnavailableDetails extends Component {
  ...
  render() {
    ...
    return (
      <AnnotationTooltip onCloseTooltip={this.props.onCloseTooltip} className="offer-when-unavailable-details">
        ...
        <button className="button-style primary-btn-large" onClick={() => this.props.viewProductPage(result.resultId)}>
          Continue to Wikibuy
        </button>
      </AnnotationTooltip>
    );
