    ...
    return (
      <div>
        <div>
          {
            ...
            <h2>
              Activated <span className="palmetto">{reward.type === 'percentage' ? `${reward.amount/100}% back` : `$${reward.amount/100} in credit`}</span>
            </h2> :
            <h2>
        ...
        </div>
        {
          ...
          <button className="primary-btn-large" style={{width: '100%', fontWeight: 'bold', marginTop: '20px'}} onClick={this.onShowCodes.bind(this)}>
