      ...
      <div className="invite-wrapper">
        ...
        <div className="invite-friends">
          ...
          <OptionSelectInput
           ...
           <button onClick={this.props.firstname || this.state.firstname ? this.inviteFriends.bind(this) : this.addName.bind(this)} className={`primary-btn-large`} disabled={!this.state.valid || this.state.sendingInvites}>
            {
...

           {
              ...
              <h4 onClick={this.copyReferral.bind(this, 'text')} className="copy-referral-link tertiary-link">
                {
                  this.state.copied ?
                  'copied' :
                  'copy invite link'
             ...
             <button onClick={this.copyReferral.bind(this, 'button')} className={`primary-btn-large green-outline-button`}>
                {
                  this.state.copied ?
                  'copied' :
                  'copy invite link'
