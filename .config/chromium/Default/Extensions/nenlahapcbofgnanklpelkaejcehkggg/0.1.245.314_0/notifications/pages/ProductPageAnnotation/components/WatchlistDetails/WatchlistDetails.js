...
const WatchlistSuccessSVG = () => (
  <svg width="60px" height="60px" viewBox="0 0 60 60">
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <circle id="Oval" stroke="#C7C7C7" strokeWidth="3" fill="#F4F4F4" cx="30" cy="30" r="28"></circle>
          <polygon fill="#C7C7C7" points="39.1981947 19 24.9669675 33.9890107 18.8018053 27.4966755 15 31.5004002 24.9669675 42 43 23.0051407"></polygon>
      </g>
  </svg>
);
...
class WatchlistDetails extends Component {
  ...
  render() {
    ...
    return (
      <AnnotationTooltip onCloseTooltip={this.props.onCloseTooltip} className="watchlist-details-tooltip">
        {
          ...
          <div>
            ...
            {
              hasAccount ?
              <h5>Add this item to your watchlist. We’ll watch for price drops over the next 60 days and email you with the best deal.</h5> :
              <h5>Sign in with Wikibuy to add this item to your watchlist. We’ll watch for price drops over the next 60 days and email you with the best deal.</h5>
            }
            {
              hasAccount ?
              <button className="button-style primary-btn-large" onClick={() => this.props.addToWatchlist('tooltipButton')}>Add to watchlist</button> :
              <button className="button-style primary-btn-large" onClick={() => window.open(`${WIKIBUY_URL}/sign-in`)}>Sign in</button>
            }
          </div> :
          <div>
            <div className="svg-graphic">
            ...
            <h5>Feel free to continue shopping or we can show you which items you have been watching by clicking the button below.</h5>
            <button className="button-style primary-btn-large" onClick={() => this.props.viewWatchlist('tooltipButton')}>View watchlist</button>
          </div>
        }
      </AnnotationTooltip>
    );
