          ...
          <div className="image-error">
            {
              ...
              <div className="product-image" style={{backgroundImage: 'url("https://cdn.ivaws.com/wikibuy-assets/images/noimage-medium.svg")', cursor}}></div>
            }
            {
              subtitle ? <h3>image not found</h3> : null
            }
          </div> : image ?
          <div className={this.props.fadeIn ? 'product-image in' : 'product-image'} style={{backgroundImage: 'url("' + image + '")', cursor}}></div> :
          <div className="product-image pad"></div>
        }
      </div>
    );
  }
