...
window.JST["onboarding/management/pinconfirmation"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(t('onboarding.management.pin_confirmation.confirm_your')));
    
      __out.push('</span>\n      <span class="black-strong-title">');
    
      __out.push(__sanitize(t('onboarding.management.pin_confirmation.pin_code')));
    
      __out.push('</span>\n      <div class="black-indication">');
    
      __out.push(__sanitize(t('onboarding.management.pin_confirmation.enter_again')));
    
      __out.push('</div>\n    </div>\n    </div>\n    <div class="page-content-container">\n      <div class="uppercase-title">');
    
      __out.push(__sanitize(t('onboarding.management.pin_confirmation.your_pin_code')));
    
      __out.push('</div>\n      <span class="invalid-indication" id="invalid_pins">');
    
      __out.push(__sanitize(t('onboarding.management.pin_confirmation.pin_codes_do_not_match')));
