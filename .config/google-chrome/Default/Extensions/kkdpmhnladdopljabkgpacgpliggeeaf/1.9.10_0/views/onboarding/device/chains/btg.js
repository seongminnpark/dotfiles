...
window.JST["onboarding/device/chains/btg"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push('</a>\n    <a id="recover" href="#splitTool" class="greyed-action medium-indication"> | ');
    
      __out.push(__sanitize(t('onboarding.device.chains.split_btg_title')));
