...
window.JST["onboarding/device/error"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize((this.params.serious != null) && this.params.serious === true ? 'error' : 'fail'));
    
      __out.push('.png" width="50" height="50" />\n    ');
    
      if (this.params.message != null) {
        __out.push('\n    <div class="black-indication">');
        __out.push(__sanitize(this.params.message));
        __out.push('</div>\n    ');
      }
    
      __out.push('\n    ');
    
      if (this.params.indication != null) {
        __out.push('\n    <div class="medium-indication">');
        __out.push(__sanitize(this.params.indication));
        __out.push('</div>\n    ');
      }
