...
window.JST["onboarding/device/failed"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<div id="content-container">\n  <div class="logo-container">\n    <img src="../../assets/images/onboarding/large_logo.png" width="191" height="96">\n  </div>\n  <div class="greyed-container">\n    <img src="../../assets/images/common/large_fail.png" width="50" height="50" />\n    <div class="black-indication">');
    
      __out.push(__sanitize(t('onboarding.device.failed.unexpected_error')));
    
      __out.push('</div>\n    <div class="medium-indication">');
    
      __out.push(__sanitize(t('onboarding.device.failed.unplug')));
    
      __out.push('</div>\n    <div class="actions-container">\n      <a class="cancel-rounded-button" href="#updateNow">');
