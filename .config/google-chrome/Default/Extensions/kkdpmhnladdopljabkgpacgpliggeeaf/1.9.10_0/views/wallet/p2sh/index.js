...
window.JST["wallet/p2sh/index"] = function (__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<section id="wallet_p2sh_index_dialog">\n  <header>\n    <h1>');
    
      __out.push(__sanitize(t('wallet.p2sh.index.title')));
    
      __out.push('</h1>\n  </header>\n  <table class="no-table-head">\n    <tbody>\n      <tr>\n        <td class="no-border">\n          ');
    
      __out.push(__sanitize(t('wallet.p2sh.index.info')));
