...
export default function shippingAndReturnsHelper(shippingAndReturns) {
  const returnsAccepted = _.find(shippingAndReturns, {name: 'Returns Accepted'}, null) || _.find(shippingAndReturns, {name: 'Returns'}, null);
  ...
  } else if (_.get(returnsAccepted, 'name') === 'Returns' && _.get(returnsAccepted, 'value') === 'free within 30 days') {
