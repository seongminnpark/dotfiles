...
function fetchInitialData() {
  return Promise.all([getUser(), siteCache(), getLoadingApps()])
...
async function onDOMReady() {
  ...
  const seenCouponCodes = new Set(_.map(_.get(siteAPIData, 'siteData.tigger.coupons') || _.get(siteAPIData, 'siteData.roo.coupons') || [], 'code'));
