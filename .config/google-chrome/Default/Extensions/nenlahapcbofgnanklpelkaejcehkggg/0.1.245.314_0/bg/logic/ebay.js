...
export default async function getOrderStats() {
  try {
    ...
    const promises = [
      getItems('http://www.ebay.com/myb/PurchaseHistoryOrdersContainer?ipp=25&Period=1&Filter=1', 2),
      getItems('http://www.ebay.com/myb/PurchaseHistoryReturnsContainer?ipp=25&Period=1&Filter=1', 2)
    ];
