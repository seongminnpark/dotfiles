...
export async function saveSettings(settings) {
  ...
  if (
    prefs && !prefs.error && (
      _.get(prefs, 'customer.zipcode') !== zipcode ||
      getPrimeMembership(prefs) !== settings.prime
    )
  ) {
...
export async function loadSettings() {
  ...
  try {
    ...
    } else if (isShadowAccount && serverPrefs && serverPrefs.customer && serverPrefs.customer.zipcode === '78756') {
