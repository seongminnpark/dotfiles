...
function getLists() {
  ...
  return exponentialBackoff(async () => {
    ...
    const whitelistFilter = new BloomFilter(whitelistConfig.bitsPerKey, whitelistConfig.numKeys, whitelistConfig.filter);
    const blacklistFilter = new BloomFilter(backlistConfig.bitsPerKey, backlistConfig.numKeys, backlistConfig.filter);
    const tracklistFilter = new BloomFilter(tracklistConfig.bitsPerKey, tracklistConfig.numKeys, tracklistConfig.filter);
    const data = {whitelist: whitelistFilter, blacklist: blacklistFilter, tracklist: tracklistFilter};
