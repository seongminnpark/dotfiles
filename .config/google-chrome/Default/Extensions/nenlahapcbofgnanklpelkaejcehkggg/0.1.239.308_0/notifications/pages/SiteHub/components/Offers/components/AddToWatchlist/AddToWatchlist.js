      ...
      <div className="wb-add-to-watchlist-component">
        {
          ...
          <div>
            ...
            {
              hasAccount ?
              <button className="full-button btn-primary-outline" onClick={() => this.addToWatchlist('sitehubButton')}>Add to watchlist</button> :
              <button className="full-button btn-primary-outline" onClick={() => window.open(`${WIKIBUY_URL}/sign-in`)}>Sign in to add</button>
            }
          </div> :
          <div>
            <h2>The item has been added to your watchlist.</h2>
            <button className="full-button btn-primary-outline" onClick={() => this.viewWatchlist('sitehubButton')}>View watchlist</button>
          </div>
        }
      </div>
    );
