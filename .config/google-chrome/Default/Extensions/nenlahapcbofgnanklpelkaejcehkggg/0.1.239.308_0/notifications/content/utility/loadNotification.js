...
export default function loadNotification(deal) {
  ...
  if (deal) {
    ...
    loadApp({
      ...
      waitForElement: true,
      maxWaitAttemps: 20,
      insertAfter: ['#price_feature_div', '#pmpux_feature_div', '#MediaMatrix', '#coursewarePrice', '#ask_feature_div', '#averageCustomerReviews_feature_div'],
      route: (
        <Route path="offers" component={App}/>
      )
    }, () => {
