...
export default async function () {
  ...
  const data = {
    ...
    checkIn: moment(new Date(document.querySelector('#totpq-localised-check-in').value)).format('MM/DD/YYYY'),
    checkOut: moment(new Date(document.querySelector('#totpq-localised-check-out').value)).format('MM/DD/YYYY'),
    ...
    latitude: document.querySelector('[property="place:location:latitude"]').getAttribute('content'),
    longitude: document.querySelector('[property="place:location:longitude"]').getAttribute('content'),
  };
  return data;
}