    ...
    if (data) {
      ...
      if (latLong) {
        ...
        if (components.length === 2) {
          ...
          const address = document.querySelector('#policies-and-amenities .full-address-container .street-address').innerText;
          ...
          const data = {title, address, price, checkIn, checkOut, rooms, adults, children, latitude, longitude};
          return data;
        }
      }
    }
