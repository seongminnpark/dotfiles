...
function checkGlobablIgnoreList() {
  ...
  if (availabilityEl) {
    if (availabilityEl.innerText.toLowerCase().indexOf('unavailable') !== -1) {
      return true;
    }
  }
  ...
  if (titleText && titleText.match(/gift\s?card|\[digital\scode\]|\bbundle|key\scard|pc\sdownload|protection\splan/i)) {
    return true;
  }
